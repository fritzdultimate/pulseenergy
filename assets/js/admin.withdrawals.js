...
let withdrawalMsgs = {
    deny : {
        ...
        msg : 'Withdrawal will be denied!'
    },
    approve : {
        title : 'Are you sure to approve?',
        msg : 'Withdrawal will be approved!'
    },
    delete : {
...
let urlPrefix = host + '/app/admin/withdrawal/';
let headers = {
...
function handleBtnAction(){
    ...
    if(withdrawalMsgs.hasOwnProperty(action)){
...
function doActionConfirm(action){
    Lobibox.confirm({
        title : withdrawalMsgs[action].title,
        msg : withdrawalMsgs[action].msg,
        soundPath,

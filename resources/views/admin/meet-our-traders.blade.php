            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-dark">Meet Our Traders</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Admin</a></li>
                            <li class="breadcrumb-item active">Meet Our Traders</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Meet Company Traders</h4>
                                    <form method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <textarea class="textarea_editor form-control" name="meet_our_traders" rows="15" placeholder="Enter text ..." style="height:300px">{{ $meet_our_traders }}</textarea>
                                        </div>
                                        <div class="text-left">

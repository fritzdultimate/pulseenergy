        ...
        <div class="Analyst_bo container bg-primar pb-5" data-v-1ba9f06e="" align="center">
            <div class="row justify-content-center p-3 p-md-0">
                <div class="col-md-6 login-container py-4 p-3 p-sm-4 p-md-5">
                    <h6 class="mx-3 page-alert h6 fw-normal mb-4 text-center">
                        Fill Up The Inputs Below To Change Password
                    </h6>
                        ...
                        <div class="bg-secondar px-3 align-items-center login-form mt-2 d-flex flex-column gap-4 justify-content-center row"
                            ...
                            <form method="post" enctype="multipart/form-data">  
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" name="password" class="form-control" placeholder="Enter password" value="{{ old('password') }}">
                                </div>
                                <div class="form-group">
                                    <label>Repeat Password</label>
                                    <input required type="text" name="repassword" class="form-control" placeholder="Repeat Password" value="{{ old('repassword') }}">
                                </div>

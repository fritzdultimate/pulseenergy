    ...
    <tr>
        <td style="padding-bottom: 10px; font-size: 14px; font-family: 'Inter', sans-serif; color: #a4a3ad;">
            ...
            <p style="margin-top: 10px; margin-bottom: 20px; width: 100%; font-size: 13px; color: rgb(22, 22, 26); font-family: 'Inter', sans-serif;">
                Your deposit of ${{ number_format($details['amount_deposited'], 2) }} has completed it's process, account updated.
            </p>

            <span style="font-size:35px; font-weight: bold; line-height: 12px; color: rgb(27, 27, 186);letter-spacing:3px;">${{ number_format($details['amount_deposited'], 2) }}</span>
        </td>
    </tr>

...
<body>
    <div bgcolor="#323232">
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
         ...
         <p> 
         Dear <strong>{{ $details['username']}}, your daily profit on an investment created with your account has stopped, because your investment has been completed and transaction sealed</strong>.
         </p>
         <p>
                Investor: <span style="color:red;font-weight:bold">{{ ucfirst($details['username']) }}</span>.
            </p>
            <p>
            ...
            <p>
                Investment Duration: <span style="color:red;font-weight:bold">{{ $details['duration'] }}</span>.
            </p>
             <p>

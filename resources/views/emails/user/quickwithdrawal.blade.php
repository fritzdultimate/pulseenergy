...
<body>
    <div bgcolor="#323232">
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
         ...
         <p> <strong>{{ env("SITE_NAME") }}</strong> has approved your withdrawal request and your provided wallet address funded.</p>
            ...
            <p>
                Transaction Hash: <span style="color:red;font-weight:bold">{{ $details['transaction_batch'] }}</span>.
            </p>

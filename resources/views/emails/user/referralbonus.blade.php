...
<body>
    <div bgcolor="#323232">
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
         ...
         <p>A confirmed deposit has been made on <strong>{{ env("SITE_NAME") }}</strong>, by a user you referred</p>
            ...
            <p>
                Bonus Received: <span style="color:red;font-weight:bold">${{ $details['bonus'] }}</span>.
            </p>
        <p>
           Keep inviting users to {{ env("SITE_SHORT_NAME") }} to make more profits.
        </p>
         </td>
         <td width="30"></td>
         </tr>

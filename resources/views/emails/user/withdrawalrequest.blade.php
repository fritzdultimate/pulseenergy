...
<body>
    <div bgcolor="#323232">
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
         ...
         <p>Your request has been received by the account management team of  <strong>{{ env("SITE_SHORT_NAME") }}</strong>.</p>
        ...
        <br><br>
        <strong>Legal:</strong> {{ env("SITE_SHORT_NAME") }} Limited is authorised and regulated by the International Financial Services Commission (IFSC) (license number 000261/158).<br><br>
        </td>
         <td width="30" bgcolor="#f5f5f5"></td>
         </tr>
        </tbody></table><table width="650" border="0" cellspacing="0" cellpadding="0">

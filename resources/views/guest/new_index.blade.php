                ...
                <div class="oe_unremovable container">
                    <div class="row content">
                        <div class="carousel-content o_colored_level pb16 o_animate o_animate_both_scroll offset-lg-1 col-lg-8 o_anim_zoom_in o_visible o_animated" style="animation-name: o_anim_zoom_in; visibility: visible; animation-play-state: running;">
                            <p><span style="font-size: 45px;"><font class="text-white">{{ env('APP_NAME') }} Continues 3D &amp; 2D Seismic Survey in Jabung Block</font></span></p><p><font class="text-o-color-4">
    ...
    <div style="background-image: url(https://www.petrochina.co.id/web/image/7512?&amp;height=256&amp;width=256);" class="o_record_cover_component o_record_cover_image "></div>
        ...
        <div class="row my-4">
                    ...
                    <div class="d-flex flex-grow-0 flex-shrink-0 col-12">
                        <div class="s_blog_posts_post pb32 w-100" data-number-of-elements="3">
    <div class="card">
        <a class="s_blog_posts_post_cover" href="/gas-sales-agreement">
<div data-name="Cover" style="" data-res-model="blog.post" data-res-id="3675" class="o_record_cover_container d-flex flex-column h-100 o_colored_level o_cc o_cc3 o_cc   thumb">
    <div style="background-image: url(https://www.petrochina.co.id/web/image/7505?&amp;height=256&amp;width=256);" class="o_record_cover_component o_record_cover_image "></div>
    
            
</div>
        </a>
        <div class="card-body">
            <a href="/gas-sales-agreement"><h4 class="mb-0">Petropulseenergy Signs 3 Gas Sales Agreement to Support Domestic Consumption</h4></a>
        </div>
        <div class="card-footer d-flex justify-content-between">
            <span class="text-muted mb-0">Aug 6, 2024</span>
            <span class="text-muted mb-0">In <a class="fw-bold" href="#blog/5">Company News</a>

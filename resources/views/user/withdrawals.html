                            ...
                            <table class="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                ...
                                <tbody>
                                    ...
                                    <tr class="background_white">
                                        ...
                                        <td>
                                            <div class="pretty p-svg p-curve">{{ $withdrawal['type'] }}</div>
                                        </td>
                                        <td>
                                            <div class="pretty p-svg p-curve">{{ $withdrawal['currency'] }}</div>
                                        </td>
                                        <td class="flag">
                                            <div class="pretty p-svg p-curve">{{ $withdrawal['date'] }}</div>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
